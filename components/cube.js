...
function Cube({progress}) {
    ...
    const texture_1 = useLoader(TextureLoader, "/images/1.jpg")
    const texture_2 = useLoader(TextureLoader, "/images/2.jpg")
    const texture_3 = useLoader(TextureLoader, "/images/3.jpg")
    const texture_4 = useLoader(TextureLoader, "/images/4.jpg")
    const texture_5 = useLoader(TextureLoader, "/images/5.jpg")
    const texture_6 = useLoader(TextureLoader, "/images/6.jpg")
